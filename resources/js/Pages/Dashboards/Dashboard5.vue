...
<template>
    ...
    >
        ...
        <!-- ================= KPI + ATTENDANCE (HORIZONTAL STRIP) ================= -->
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <!-- Students -->
            <div
                class="backdrop-blur-xl bg-white/70 border rounded-2xl p-4 shadow-sm"
            >
                <p class="text-xs text-gray-500">Students</p>
                <p class="text-xl font-bold">{{ props.stats.students }}</p>
            </div>
            ...
            >
                ...
                <p class="text-xl font-bold">{{ props.stats.teachers }}</p>
            </div>
            ...
            >
                ...
                <p class="text-xl font-bold">{{ props.stats.courses }}</p>
            </div>
            ...
            >
                ...
                <p class="text-xl font-bold">{{ props.stats.sections }}</p>
            </div>

            <!-- Present -->
            <div class="bg-green-50 border rounded-2xl p-4">
            ...
            <!-- Absent -->
            <div class="bg-red-50 border rounded-2xl p-4">
            ...
            <!-- Late -->
            <div class="bg-yellow-50 border rounded-2xl p-4">
